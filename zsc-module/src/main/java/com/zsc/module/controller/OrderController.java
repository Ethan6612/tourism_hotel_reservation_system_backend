...
public class OrderController extends BaseController {
    ...
    public AjaxResult updateRemark(@PathVariable Long id, @RequestParam(required = false) String remark) {
    ...
    public AjaxResult checkin(@PathVariable Long id, @RequestParam(required = false) String remark) {
    ...
    public AjaxResult checkout(@PathVariable Long id, @RequestParam(required = false) String remark) {
